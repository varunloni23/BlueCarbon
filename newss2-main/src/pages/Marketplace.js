    ...
    try {
      ...
      const mockListings = [
        ...
        },
        {
          ...
          certification_level: 'Verified Carbon Standard',
        ...
        },
        {
          ...
          certification_level: 'Climate Action Reserve',
            ...
            <Grid item xs={12} md={6} lg={4} key={listing.listing_id}>
              <Card>
                ...
                {listing.ecosystem_type && (
                  <img 
                    src={`http://localhost:8002/images/${listing.ecosystem_type === 'salt_marsh' ? 'saltmarsh' : listing.ecosystem_type === 'coastal_wetland' ? 'coastalwetland' : listing.ecosystem_type === 'coral_reef' ? 'coralreef' : listing.ecosystem_type}.png`}
                    alt={`${listing.ecosystem_type} ecosystem`}
                    style={{ 
                      width: '100%', 
                      height: '200px', 
                      objectFit: 'cover'
                ...
                <CardContent>
                  ...
                  {/* Ecosystem Type Display */}
                  {listing.ecosystem_type && (
                    <Chip 
                      label={listing.ecosystem_type.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase())}
                      color="secondary"
                      size="small"
                      sx={{ mt: 1, mb: 2 }}
                    />
                  ...
                  <Typography variant="body2" sx={{ mt: 2, mb: 2 }}>
                    <strong>Project:</strong> {listing.project_name || listing.project_id}
                  </Typography>
